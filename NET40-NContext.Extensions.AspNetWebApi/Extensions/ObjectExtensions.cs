namespace System
{
    ...
    {
        private static readonly MethodInfo _CloneMethod = typeof(Object).GetTypeInfo().GetDeclaredMethod("MemberwiseClone");
        ...
        {
            var filtered = new List<FieldInfo>(typeToReflect.GetTypeInfo().DeclaredFields);
            if (filter != null)
            {
