namespace NContext.Tests.Specs.Security.Cryptography
{
    ...
    public class when_using_salt_stream : when_hashing_with_HashProvider
    {
        Establish context = () => _PlainText = new MemoryStream("NContext".ToBytes<UTF8Encoding>());

        Because of = () => _SourceHash = HashProvider.CreateHash(_PlainText);
        ...
        It should_equal_the_target_Byte_array = () =>
        {
            ...
            HashProvider.CompareHash(_PlainText, _SourceHash).ShouldBeTrue();
        };
